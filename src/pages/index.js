	...
	return <Theme theme={theme}>
		...
		<Section padding="100px 0" sm-padding="40px 0">
			...
			<Text as="p" font="--lead" margin="20px 0 0 0">
				Name: Abinash Boruah
				<br />
				Managed by: Ramesh Boruah
				<br />
				Contact/e mail: boruahabinash0@gmail.com
			</Text>
		</Section>
			...
			<Stack>
				<StackItem width="50%" lg-width="100%">
					<Override
						...
						margin-right="-20%"
						padding-bottom="120%"
						background="url(https://uploads.quarkly.io/5fccdb0b057d16001e794145/images/2018-09-04-16-13-37%20-%20Copy%20(2).jpg?v=2020-12-06T13:30:34.875Z) 50% 15%/cover"
						lg-margin-right="0"
